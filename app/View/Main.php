...
{
    protected function container($data = [])
    {
        ?>
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="side-content side-content-full">
                                <ul class="nav-main">
                                    ...
                                    <li>
                                        <a href="/gallery"><i class="si si-picture"></i><span class="sidebar-mini-hide">Галерея</span></a>
                                    </li>   
                                </ul>
                            </div>
                            <!-- END Side Content -->
                        ...
                        <div class="row items-push">
                            <div class="col-sm-7">
                                <h1 class="page-heading">
                                    <?= isset($data['title']) ? $data['title'] : 'Заголовок страницы' ?>
                                </h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    foreach ($buttons as $button) {
                        echo '<a class="btn btn-minw btn-rounded btn-success" href="' . $button['route'] . '">' . $button['lebel'] . '</a>';
                    }
                    ?>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    foreach ($options as $key=>$column) {
                                        echo '<th class="' . $column['class'] . '">' . $column['lebel'] . '</th>';
                                    }
                                    ?>
                                </tr>
                            </thead>
